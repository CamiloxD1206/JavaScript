// rpm 3 objetos
//darle datos a obejtos con prompt(cada objeto minimo 5)
...
console.log(`el motoviajero ${motoviajero.nombre} con numero de identficacion ${motoviajero.id} recorrio un total de ${ruta.kilometros}Km en la ruta ${ruta.puntodepartida}-${ruta.puntodellegada},tuvo paradas en ${ruta.paradas} gasto un total de ${totalpresupuesto} durante todo el trayecto`);